...
query['ancillary_song_insert'] = 'insert into d_song (song_name, artist_id) values (%s, (select artist_id from d_artist where artist_name=%s)) on conflict (song_name, artist_id) do nothing'

query['ancillary_artist_insert'] = 'insert into d_artist (artist_name) values (%s) on conflict (artist_name) do nothing'
